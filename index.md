...
venue: "Amsterdam"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Singel 425"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
language: "Dutch"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
...
instructor: ["Alice Doek", Henriette Reerink] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
